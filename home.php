...
<body>
        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <?php if (isset($_SESSION['username'])): ?>
                <li class="scroll-to-section">
                  ...
                  if (isset($_SESSION['role']) && isset($_SESSION['name'])) {
                    // Cek peran (role) pengguna dan buat link berdasarkan role
                    if ($_SESSION['role'] == 'guru') {
                      // Jika role adalah guru, arahkan ke homeguru.php dengan link
                      echo '<a href="guru/homeguru.php">Welcome, ' . $_SESSION['name'] . '</a>';
                    } elseif ($_SESSION['role'] == 'siswa') {
                      // Jika role adalah siswa, arahkan ke homesiswa.php dengan link
                      echo '<a href="siswa/homesiswa.php">Welcome, ' . $_SESSION['name'] . '</a>';
                    } else {
                      // Jika role tidak sesuai, tampilkan pesan error atau arahkan ke halaman lain
              ...
              <?php else: ?>
                <li>
                  <a class="scroll-to-section" href="login.php">Sing in</a>
                </li>
              <?php endif; ?>
            </ul>
          ...
          <div class="owl-carousel owl-banner">
            <div class="item item-1">
              <div class="header-text">
                ...
                <h2>What is a laboratory Computer</h2>
                <p>Laboratory lending is the process by which an individual or group, such as a student, lecturer, or researcher, obtains permission to use a laboratory facility for a certain period of time. Typically, these laboratories are equipped with equipment and materials used for experimental, research, or practicum activities.</p>
              </div>
            </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6">
          <div class="team-member">
            <div class="main-content">
              <!-- <img src="assets/image/pn.jpeg" alt=""> -->
              <img src="assets/images/person-logo.png" alt="">
              <span class="category">UX Developer</span>
              <h4>ACHMAD CAHYO WIDODO</h4>
              <!-- <ul class="social-icons">
                <li><a href="#"><i class="fab fa-facebook"></i></a></li>
                <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                <li><a href="#"><i class="fab fa-linkedin"></i></a></li>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="team-member">
            <div class="main-content">
              <!-- <img src="assets/image/logo-ikspi.jpeg" alt=""> -->
              <img src="assets/images/person-logo.png" alt="">
              <span class="category">UI Developer</span>
              <h4>AGUSTAV NOVAL PRATAMA</h4>
              <!-- <ul class="social-icons">
                <li><a href="#"><i class="fab fa-facebook"></i></a></li>
                <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                <li><a href="#"><i class="fab fa-linkedin"></i></a></li>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="team-member">
            <div class="main-content">
              <!-- <img src="assets/image/sh.png" alt=""> -->
              <img src="assets/images/person-logo.png" alt="">
              <span class="category">UX Developer</span>
              <h4>BILLY OTTO ADINATA</h4>
              <!-- <ul class="social-icons">
                <li><a href="#"><i class="fab fa-facebook"></i></a></li>
                <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                <li><a href="#"><i class="fab fa-linkedin"></i></a></li>
  ...
  <footer>
    <div class="container">
      <div class="col-lg-12">
        <p class="text-center">Copyright © 2024 SMKN 11 MALANG All rights reserved.</p>
      </div>
    </div>
  </footer>
